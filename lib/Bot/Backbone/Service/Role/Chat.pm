...
The second argument may either be a string to send as the text reply or a hash
reference of options, which is used to modify the reply further. See
L</send_message> for additional options and be aware that individual chat
implementations may provide more options in addition to those shown here.
